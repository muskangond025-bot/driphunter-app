...
export default function OrderTrackingPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground font-sans antialiased pb-20">
      <AppHeader title="Order Details" variant="contextual" fallbackUrl="/mobile/orders" showActions={false} />
