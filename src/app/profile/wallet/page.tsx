      ...
      <main className="flex-grow flex flex-col">
        <div className="flex flex-col lg:flex-row min-h-[calc(100vh-80px)]">
          ...
          <div className="w-full lg:w-1/2 bg-gradient-to-br from-zinc-950 via-black to-zinc-950 p-8 sm:p-12 lg:p-20 xl:p-24 flex flex-col justify-center relative overflow-hidden border-r border-zinc-900 shadow-[inset_0_0_100px_rgba(0,0,0,0.8)]">
            ...
            <div className="absolute top-0 right-0 w-[600px] max-w-full h-[600px] bg-[#E6C280]/5 blur-[150px] rounded-full pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-[600px] max-w-full h-[600px] bg-emerald-900/10 blur-[150px] rounded-full pointer-events-none" />
            ...
            <div className="relative z-10 space-y-10 max-w-xl">
              ...
              <div className="space-y-6">
                ...
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-light tracking-tight text-white font-playfair leading-[1.05] uppercase">
                  Your <span className="font-serif italic font-normal text-[#E6C280] lowercase">Funds</span>
                </h1>
                <p className="text-sm sm:text-base text-zinc-400 font-sans leading-relaxed max-w-md">
                  Your wallet is loaded and ready. Use these funds for frictionless, one-tap checkout during our exclusive drops.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 bg-white dark:bg-zinc-950 p-8 sm:p-12 lg:p-20 xl:p-24 flex flex-col justify-center relative">
            <div className="max-w-md w-full mx-auto relative z-10">
              ...
              <div className="text-center space-y-8 animate-fade-in-up">
                <div className="w-24 h-24 rounded-full bg-emerald-500/10 border border-emerald-500/40 flex items-center justify-center mx-auto shadow-[0_0_50px_rgba(16,185,129,0.2)]">
                  <CheckCircle2 className="w-12 h-12 text-emerald-500" />
                </div>
                <div>
                  <span className="text-[10px] font-mono text-emerald-600 dark:text-emerald-400 uppercase tracking-[0.3em] font-bold block mb-4">
                    Transaction Complete
                  </span>
                  <h4 className="text-4xl font-playfair font-normal text-zinc-900 dark:text-white mb-4">
                    Funds Added!
                  </h4>
                  <p className="text-sm text-zinc-500 font-sans leading-relaxed px-4">
                    ₹2,500 has been successfully added to your DripHunter Wallet. Your balance is instantly available for checkout.
                  </p>
                </div>
                <div className="flex flex-col gap-4 pt-6">
                  <Link
                    href="/shop"
                    className="inline-flex items-center justify-center w-full bg-zinc-950 dark:bg-white text-white dark:text-zinc-950 py-5 rounded-none text-[11px] font-mono font-black uppercase tracking-[0.2em] transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 cursor-pointer"
                  >
                    Start Shopping
                  </Link>
                  <Link
